...
# with command line options: RECO --conditions 106X_upgrade2018_realistic_v16_L1v1 --datatier NANOAODSIM --eventcontent NANOAODSIM --era Run2_2018,run2_nanoAOD_106Xv2 --geometry DB:Extended --customise Configuration/DataProcessing/Utils.addMonitoring, PhysicsTools/NanoAOD/nanoTP_cff.customizeNANOTP, PhysicsTools/NanoAOD/nano_cff.customizeGenLeptonPrecision --filein dbs:/DYJetsToMuMu_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/RunIISummer20UL18RECO-106X_upgrade2018_realistic_v11_L1v1-v3/AODSIM --fileout file:NanoV9MC2018TagAndProbe.root --nThreads 4 --no_exec --python_filename configs/NanoV9MC2018TagAndProbe_cfg.py --mc --scenario pp --step PAT,USERNANO:nanotpSequenceMC --runUnscheduled -n 1000
